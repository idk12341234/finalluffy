...
function preload(){
  ...
  luffy_collided = loadAnimation("assets/luffy5.png")
  jungleImage = loadImage("assets/bg.png");
  obstacel1Img = loadAnimation("assets/o1.png","assets/o2better.png")
  obstacle2Img = loadImage("assets/newo2.png")
  obstacle3Img = loadImage("assets/monster1img.png")
  obstacle4Img = loadAnimation("assets/dino1b.png","assets/dino2b.png","assets/dino3b.png")
...
function setup() {
  ...
  luffy.addAnimation("collided",luffy_collided)
...
if(gameState===END)
 {
  ...
  obstaclesGroup.setVelocityXEach(0);
  obstaclesGroup.setLifetimeEach(-1);
  luffy.changeAnimation("collided",luffy_collided)
  lootGroup.setVelocityXEach(0);
  lootGroup.setLifetimeEach(-1);
 }
...
{
if(frameCount % 260 === 0) {
  var loot = createSprite(200,100,40,10);
  loot.addAnimation("flying",obstacle4Img)
  loot.velocityX = -(6 + 3*score/80)
  loot.scale = 0.7;
